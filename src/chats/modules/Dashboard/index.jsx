...
import tutorialsdev from "../../../_assets/tutorialsdev.png";
...
const Dashboard = () => {
  ...
  // Socket connection for sending and receiving messages
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchConversations = async () => {
      const res = await fetch(
        `http://localhost:4000/api/conversations/${loggedInUser?.id}`,
        {
          method: "GET",
          headers: {
  ...
  // Fetch all users for the logged-in user
  useEffect(() => {
  ...
  // Fetch messages between the user and a conversation or receiver
  ...
  // Send message through the socket and store it in the database
  ...
  return (
    <div className="w-screen flex">
      {/* Left sidebar with user info and conversations */}
